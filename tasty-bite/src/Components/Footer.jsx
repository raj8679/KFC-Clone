...
<Box className={styles.topBox}>
    <Box className={styles.logoImg}><Image w="100%" h="100%" src="https://images.ctfassets.net/wtodlh47qxpt/25FSYFuEtGct8NSrtpKe6d/b602f6fe0bf294e6a6dff5d7648bf594/KFC_Logo.svg"></Image></Box>
...
<Box className={styles.belowBox}>
    <Box className={styles.copyrightBox}>Copyright © KFC Corporation 2021 All Rights Reserved</Box>
